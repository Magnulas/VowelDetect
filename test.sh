...
for nmix in 1 2 4 8 
	...
	./evaluate_testdata.out "gmms/A.gmm" "gmm_data/A_test.data" "gmms/AO.gmm" "gmm_data/AO_test.data" "gmms/I.gmm" "gmm_data/I_test.data" "gmms/O.gmm" "gmm_data/O_test.data"
	done
